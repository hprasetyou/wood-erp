...
class CurrencyTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Code', 'Symbol', 'Placement', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'code', 'symbol', 'placement', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID, CurrencyTableMap::COL_NAME, CurrencyTableMap::COL_CODE, CurrencyTableMap::COL_SYMBOL, CurrencyTableMap::COL_PLACEMENT, CurrencyTableMap::COL_CREATED_AT, CurrencyTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'code', 'symbol', 'placement', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Code' => 2, 'Symbol' => 3, 'Placement' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'code' => 2, 'symbol' => 3, 'placement' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID => 0, CurrencyTableMap::COL_NAME => 1, CurrencyTableMap::COL_CODE => 2, CurrencyTableMap::COL_SYMBOL => 3, CurrencyTableMap::COL_PLACEMENT => 4, CurrencyTableMap::COL_CREATED_AT => 5, CurrencyTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'code' => 2, 'symbol' => 3, 'placement' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
