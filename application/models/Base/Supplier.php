...
abstract class Supplier implements ActiveRecordInterface
{
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[SupplierTableMap::COL_EMAIL] = true;
        }
    ...
    public function setBankDetail($v)
    {
        ...
        if ($this->bank_detail !== $v) {
            $this->bank_detail = $v;
            $this->modifiedColumns[SupplierTableMap::COL_BANK_DETAIL] = true;
        }
    ...
    public function setTaxNumber($v)
    {
        ...
        if ($this->tax_number !== $v) {
            $this->tax_number = $v;
            $this->modifiedColumns[SupplierTableMap::COL_TAX_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SupplierTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SupplierTableMap::translateFieldName('BankDetail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bank_detail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SupplierTableMap::translateFieldName('TaxNumber', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = SupplierTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(SupplierTableMap::COL_BANK_DETAIL)) {
            $modifiedColumns[':p' . $index++]  = 'bank_detail';
        }
        if ($this->isColumnModified(SupplierTableMap::COL_TAX_NUMBER)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getBankDetail(),
            $keys[6] => $this->getTaxNumber(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setBankDetail($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setTaxNumber($arr[$keys[6]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_EMAIL)) {
            $criteria->add(SupplierTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(SupplierTableMap::COL_BANK_DETAIL)) {
            $criteria->add(SupplierTableMap::COL_BANK_DETAIL, $this->bank_detail);
        }
        if ($this->isColumnModified(SupplierTableMap::COL_TAX_NUMBER)) {
            $criteria->add(SupplierTableMap::COL_TAX_NUMBER, $this->tax_number);
        }
