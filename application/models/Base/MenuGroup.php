...
abstract class MenuGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MenuGroupTableMap';
    ...
    /**
     * Initializes internal state of Base\MenuGroup object.
     */
     ...
     * @return $this|\MenuGroup The current object (for fluent API support)
     */
    public function setMenuId($v)
    {
        ...
        if ($this->menu_id !== $v) {
            $this->menu_id = $v;
            $this->modifiedColumns[MenuGroupTableMap::COL_MENU_ID] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[MenuGroupTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MenuGroupTableMap::translateFieldName('MenuId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuGroupTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MenuGroupTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MenuGroup'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuGroupTableMap::COL_MENU_ID)) {
            $modifiedColumns[':p' . $index++]  = 'menu_id';
        }
        if ($this->isColumnModified(MenuGroupTableMap::COL_GROUP_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuGroupTableMap::COL_MENU_ID)) {
            $criteria->add(MenuGroupTableMap::COL_MENU_ID, $this->menu_id);
        }
        if ($this->isColumnModified(MenuGroupTableMap::COL_GROUP_ID)) {
            $criteria->add(MenuGroupTableMap::COL_GROUP_ID, $this->group_id);
        }
    ...
    public function hashCode()
    {
        ...
        //relation menu_group_fk_1e5706 to table menu
        ...
        //relation menu_group_fk_1a8724 to table ugroup
    ...
    {
        return (null === $this->getMenuId()) && (null === $this->getGroupId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MenuGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MenuGroup Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aMenu === null && ($this->menu_id != 0)) {
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroup->addMenuGroups($this);
             */
        }
    ...
    {
        if (null !== $this->aMenu) {
            $this->aMenu->removeMenuGroup($this);
        }
        if (null !== $this->aGroup) {
            $this->aGroup->removeMenuGroup($this);
        }
        $this->menu_id = null;
        $this->group_id = null;
        $this->alreadyInSave = false;
