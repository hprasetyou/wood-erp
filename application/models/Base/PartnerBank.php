...
/**
 * Base class that represents a row from the 'partner_bank' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class PartnerBank implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PartnerBankTableMap';
    ...
    /**
     * The value for the acount_no field.
     *
     * @var        string
     */
    protected $acount_no;
    ...
    /**
     * Initializes internal state of Base\PartnerBank object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>PartnerBank</code> instance.  If
     * <code>obj</code> is an instance of <code>PartnerBank</code>, delegates to
     * <code>equals(PartnerBank)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PartnerBank The current object, for fluid interface
     */
    ...
    /**
     * Get the [acount_no] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PartnerBankTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PartnerBankTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [acount_no] column.
     *
     * @param string $v new value
     * @return $this|\PartnerBank The current object (for fluent API support)
     */
    public function setAccountNo($v)
    {
        ...
        if ($this->acount_no !== $v) {
            $this->acount_no = $v;
            $this->modifiedColumns[PartnerBankTableMap::COL_ACOUNT_NO] = true;
        }
    ...
    public function setPartnerId($v)
    {
        ...
        if ($this->partner_id !== $v) {
            $this->partner_id = $v;
            $this->modifiedColumns[PartnerBankTableMap::COL_PARTNER_ID] = true;
        }
    ...
    public function setBankId($v)
    {
        ...
        if ($this->bank_id !== $v) {
            $this->bank_id = $v;
            $this->modifiedColumns[PartnerBankTableMap::COL_BANK_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PartnerBankTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PartnerBankTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PartnerBankTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PartnerBankTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PartnerBankTableMap::translateFieldName('AccountNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acount_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PartnerBankTableMap::translateFieldName('PartnerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPartnerBankQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PartnerBank::setDeleted()
     * @see PartnerBank::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPartnerBankQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PartnerBankTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PartnerBankTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_ACOUNT_NO)) {
            $modifiedColumns[':p' . $index++]  = 'acount_no';
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_PARTNER_ID)) {
        ...
        if ($this->isColumnModified(PartnerBankTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO partner_bank (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'acount_no':
                        $stmt->bindValue($identifier, $this->acount_no, PDO::PARAM_STR);
                        break;
                    case 'partner_id':
    ...
    {
        $pos = PartnerBankTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PartnerBank'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PartnerBank'][$this->hashCode()] = true;
        $keys = PartnerBankTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PartnerBankTableMap::COL_ID)) {
            $criteria->add(PartnerBankTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_NAME)) {
            $criteria->add(PartnerBankTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_ACOUNT_NO)) {
            $criteria->add(PartnerBankTableMap::COL_ACOUNT_NO, $this->acount_no);
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_PARTNER_ID)) {
            $criteria->add(PartnerBankTableMap::COL_PARTNER_ID, $this->partner_id);
        }
        if ($this->isColumnModified(PartnerBankTableMap::COL_BANK_ID)) {
        ...
        if ($this->isColumnModified(PartnerBankTableMap::COL_UPDATED_AT)) {
            $criteria->add(PartnerBankTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPartnerBankQuery::create();
        $criteria->add(PartnerBankTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PartnerBank (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PartnerBank Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPartner(ConnectionInterface $con = null)
    {
        if ($this->aPartner === null && ($this->partner_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPartner->addPartnerBanks($this);
             */
        }
    ...
    public function getBank(ConnectionInterface $con = null)
    {
        if ($this->aBank === null && ($this->bank_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBank->addPartnerBanks($this);
             */
        }
    ...
    {
        if (null !== $this->aPartner) {
            $this->aPartner->removePartnerBank($this);
        }
        if (null !== $this->aBank) {
            $this->aBank->removePartnerBank($this);
        }
        $this->id = null;
        $this->name = null;
        $this->acount_no = null;
    ...
    {
        return (string) $this->exportTo(PartnerBankTableMap::DEFAULT_STRING_FORMAT);
    }
