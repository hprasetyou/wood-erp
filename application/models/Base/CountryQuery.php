 ...
 *
 * @method     ChildCountryQuery leftJoinPartnerLocation($relationAlias = null) Adds a LEFT JOIN clause to the query using the PartnerLocation relation
 * @method     ChildCountryQuery rightJoinPartnerLocation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PartnerLocation relation
 * @method     ChildCountryQuery innerJoinPartnerLocation($relationAlias = null) Adds a INNER JOIN clause to the query using the PartnerLocation relation
 *
 * @method     ChildCountryQuery joinWithPartnerLocation($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the PartnerLocation relation
 *
 * @method     ChildCountryQuery leftJoinWithPartnerLocation() Adds a LEFT JOIN clause and with to the query using the PartnerLocation relation
 * @method     ChildCountryQuery rightJoinWithPartnerLocation() Adds a RIGHT JOIN clause and with to the query using the PartnerLocation relation
 * @method     ChildCountryQuery innerJoinWithPartnerLocation() Adds a INNER JOIN clause and with to the query using the PartnerLocation relation
 *
 * @method     \PartnerLocationQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CountryQuery extends ModelCriteria
{
    ...
    public function filterByPartnerLocation($partnerLocation, $comparison = null)
    {
        if ($partnerLocation instanceof \PartnerLocation) {
            return $this
                ->addUsingAlias(CountryTableMap::COL_ID, $partnerLocation->getCountryId(), $comparison);
