...
/**
 * Base class that represents a query for the 'supplier_type' table.
 *
 *
 *
 ...
 * @method     ChildSupplierTypeQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildSupplierTypeQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSupplierTypeQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSupplierTypeQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSupplierTypeQuery leftJoinPartner($relationAlias = null) Adds a LEFT JOIN clause to the query using the Partner relation
 * @method     ChildSupplierTypeQuery rightJoinPartner($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Partner relation
 * @method     ChildSupplierTypeQuery innerJoinPartner($relationAlias = null) Adds a INNER JOIN clause to the query using the Partner relation
 *
 * @method     ChildSupplierTypeQuery joinWithPartner($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Partner relation
 *
 * @method     ChildSupplierTypeQuery leftJoinWithPartner() Adds a LEFT JOIN clause and with to the query using the Partner relation
 * @method     ChildSupplierTypeQuery rightJoinWithPartner() Adds a RIGHT JOIN clause and with to the query using the Partner relation
 * @method     ChildSupplierTypeQuery innerJoinWithPartner() Adds a INNER JOIN clause and with to the query using the Partner relation
 *
 * @method     \PartnerQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildSupplierType findOne(ConnectionInterface $con = null) Return the first ChildSupplierType matching the query
 ...
 *
 */
abstract class SupplierTypeQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\SupplierTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\SupplierType', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildSupplierTypeQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildSupplierTypeQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildSupplierTypeQuery) {
            return $criteria;
        }
        $query = new ChildSupplierTypeQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildSupplierType|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SupplierTypeTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildSupplierType A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildSupplierType $obj */
            $obj = new ChildSupplierType();
            $obj->hydrate($row);
            SupplierTypeTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $id, $comparison);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSupplierTypeQuery The current query, for fluid interface
     */
    public function filterByPartner($partner, $comparison = null)
    {
        if ($partner instanceof \Partner) {
            return $this
                ->addUsingAlias(SupplierTypeTableMap::COL_ID, $partner->getSupplierTypeId(), $comparison);
     ...
     *
     * @param   ChildSupplierType $supplierType Object to remove from the list of results
     *
     * @return $this|ChildSupplierTypeQuery The current query, for fluid interface
     */
    public function prune($supplierType = null)
    {
        if ($supplierType) {
            $this->addUsingAlias(SupplierTypeTableMap::COL_ID, $supplierType->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the supplier_type table.
     *
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            SupplierTypeTableMap::clearInstancePool();
            SupplierTypeTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(SupplierTypeTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            SupplierTypeTableMap::removeInstanceFromPool($criteria);
