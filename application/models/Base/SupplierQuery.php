 ...
 * @method     ChildSupplierQuery orderByEmail($order = Criteria::ASC) Order by the email column
 * @method     ChildSupplierQuery orderByBankDetail($order = Criteria::ASC) Order by the bank_detail column
 * @method     ChildSupplierQuery orderByTaxNumber($order = Criteria::ASC) Order by the tax_number column
 *
 ...
 * @method     ChildSupplierQuery groupByEmail() Group by the email column
 * @method     ChildSupplierQuery groupByBankDetail() Group by the bank_detail column
 * @method     ChildSupplierQuery groupByTaxNumber() Group by the tax_number column
 *
 ...
 * @method     ChildSupplier findOneByEmail(string $email) Return the first ChildSupplier filtered by the email column
 * @method     ChildSupplier findOneByBankDetail(string $bank_detail) Return the first ChildSupplier filtered by the bank_detail column
 * @method     ChildSupplier findOneByTaxNumber(string $tax_number) Return the first ChildSupplier filtered by the tax_number column *
 ...
 * @method     ChildSupplier requireOneByEmail(string $email) Return the first ChildSupplier filtered by the email column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSupplier requireOneByBankDetail(string $bank_detail) Return the first ChildSupplier filtered by the bank_detail column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSupplier requireOneByTaxNumber(string $tax_number) Return the first ChildSupplier filtered by the tax_number column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSupplier[]|ObjectCollection findByEmail(string $email) Return ChildSupplier objects filtered by the email column
 * @method     ChildSupplier[]|ObjectCollection findByBankDetail(string $bank_detail) Return ChildSupplier objects filtered by the bank_detail column
 * @method     ChildSupplier[]|ObjectCollection findByTaxNumber(string $tax_number) Return ChildSupplier objects filtered by the tax_number column
...
abstract class SupplierQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, address, phone, email, bank_detail, tax_number FROM supplier WHERE id = :p0';
        try {
    ...
    public function filterByEmail($email = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SupplierTableMap::COL_EMAIL, $email, $comparison);
    }
    ...
    public function filterByBankDetail($bankDetail = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SupplierTableMap::COL_BANK_DETAIL, $bankDetail, $comparison);
    }
    ...
    public function filterByTaxNumber($taxNumber = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SupplierTableMap::COL_TAX_NUMBER, $taxNumber, $comparison);
    }
