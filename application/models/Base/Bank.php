...
abstract class Bank implements ActiveRecordInterface
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BankTableMap::COL_NAME] = true;
        }
    ...
    public function setCodeName($v)
    {
        ...
        if ($this->ref_code !== $v) {
            $this->ref_code = $v;
            $this->modifiedColumns[BankTableMap::COL_REF_CODE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BankTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BankTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_NAME)) {
        ...
        if ($this->isColumnModified(BankTableMap::COL_UPDATED_AT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_NAME)) {
            $criteria->add(BankTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(BankTableMap::COL_REF_CODE)) {
        ...
        if ($this->isColumnModified(BankTableMap::COL_UPDATED_AT)) {
            $criteria->add(BankTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function setPartnerBanks(Collection $partnerBanks, ConnectionInterface $con = null)
    {
        ...
        foreach ($partnerBanksToDelete as $partnerBankRemoved) {
            $partnerBankRemoved->setBank(null);
        }
     ...
     * @return ObjectCollection|ChildPartnerBank[] List of ChildPartnerBank objects
     */
    public function getPartnerBanksJoinPartner(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPartnerBankQuery::create(null, $criteria);
